...
export default function ProgramDetails() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/api/programs/${id}`) // ✅ API call
      .then(res => {
        setProgram(res.data);
        setLoading(false);
      })
  ...
  return (
    <div className="p-6">
      ...
      <p className="mb-2"><strong>Duration:</strong> {program.duration}</p>
      <p className="mb-2"><strong>Eligibility:</strong> {program.eligibility}</p>
